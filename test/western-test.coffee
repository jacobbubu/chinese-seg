...
test 'middleware western runs', (t) ->
  ...
  t.test 'Chinese mixed in the text', (t) ->
  ...
  t.test 'Combine punctuation and western', (t) ->
    ...
    expected = [
      ...
      { w: '而且在处理英语当中的外来词如naïve', start: 53, props: western: 1 }
