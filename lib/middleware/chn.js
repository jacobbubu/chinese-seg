...
module.exports = function(options) {
  var DATETIME, byWord, dict, dictFiles, dictPath, filterWord, fn, getChunks, getTops, groupByPos, matchWord, name, optimizer, tokenize;
  ...
  groupByPos = function(words, text) {
    var i, word, wordpos, _i, _j, _len, _name, _ref2;
    wordpos = {};
    for (_i = 0, _len = words.length; _i < _len; _i++) {
      word = words[_i];
  ...
  filterWord = function(words, prevParam, text) {
    var avgLengthOfWord, chunk, chunkLength, chunks, currChunk, currProps, hasOne, hasVerb, i, indexInChunk, j, key, nextProps, nextWord, prevProps, prevWord, ret, scores, top, word, wordPos, _ref2, _ref3, _ref4;
    hasOne = function() {
    ...
    return ret = optimizer(currChunk);
  };
  matchWord = function(text, curr, prevWord) {
    var i, len, ret, w, wordList, _ref2, _ref3;
    ret = [];
    if (dict != null) {
      i = curr;
      while (i < text.length) {
